...
import { getReviewer, getCurrentUserId, type Reviewer as ReviewerType, type Review } from "../api/client";
...
import { getReviewerDeepLink } from "../lib/deepLinks.js";
        ...
        <div className="flex flex-col gap-3">
          {reviews.length === 0 ? (
            <p className="text-center text-tg-hint py-4">
              {isOwnProfile ? t("reviewer.noReviewsOwn") : t("reviewer.noReviews")}
            </p>
          ) : (
            reviews.map((review) => (
              <ReviewCard
